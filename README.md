...
Lead scoring project have analysis done using Python libraries to solve the problem.
Framework and tools used: numpy, pandas, Scikit lear, matplotlib, Graphs and tool used is Jupyter notebook.
